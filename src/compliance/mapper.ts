...
/**
 * Input type for creating compliance records (without DB-generated fields).
 * Used by mapEventToCompliance to produce records before insertion.
 */
...
/**
 * Re-export ComplianceRecord from types as the full DB type for convenience.
 * This has id and created_at fields that are generated by the database.
 */
export type { ComplianceRecord } from '../types.js';
...
/**
 * Map an agent event to applicable compliance records.
 * Newly mapped events are always marked as 'pending' — not auto-compliant.
 * Compliance status must be explicitly verified.
 */
export function mapEventToCompliance(
  ...
  const records: ComplianceRecordInput[] = [];
